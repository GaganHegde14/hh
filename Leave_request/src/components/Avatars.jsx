...
import ApplyCancelLeaveForm from "./ApplyCancelLeaveForm";

const Avatars = ({ initialLeaveType }) => {
  ...
  const handleLeaveCardClick = (leaveType) => {
    ...
    // Add your leave card click logic here
    // This is where you can integrate with backend API calls
  };
  ...
  return (
    <div className="avatars-container">
      ...
      <LeaveCards onCardClick={handleLeaveCardClick} />

      <div className="content-surface">
        <ApplyCancelLeaveForm initialLeaveType={initialLeaveType} />
      </div>
    </div>
  );
};
